...
export default function Footer() {
  ...
  // Helper to map SVG icons to the centralized contactInfo
  const getIcon = (label) => {
    switch (label) {
      case 'Address':
        return (
      ...
      <div className="footer__main container">
        <div className="footer__col footer__col--brand">
          ...
          <div className="footer__socials">
            <a href={socialLinks.facebook} className="footer__social" aria-label="Facebook" target="_blank" rel="noopener noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
            </a>
            <a href={socialLinks.instagram} className="footer__social" aria-label="Instagram" target="_blank" rel="noopener noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>
            </a>
            <a href={socialLinks.twitter} className="footer__social" aria-label="Twitter" target="_blank" rel="noopener noreferrer">
            ...
            {socialLinks.youtube !== '#' && (
              <a href={socialLinks.youtube} className="footer__social" aria-label="YouTube" target="_blank" rel="noopener noreferrer">
          ...
          <ul className="footer__contact-list">
            {contactInfo.map(({ label, value }) => (
              <li key={label} className="footer__contact-item">
                <span className="footer__contact-icon">{getIcon(label)}</span>
                <span className="footer__contact-text">{value}</span>
              </li>
            ))}
          </ul>
        </div>
